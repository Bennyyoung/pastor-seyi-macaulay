...
export { background, borderRadius, borders, boxShadow, dimensions, flex, grid, interaction, layout, list, opacity, overflow, position, spacing, text, transform, transition };
